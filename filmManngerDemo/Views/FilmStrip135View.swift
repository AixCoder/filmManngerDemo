...
class FilmStrip135View: UIView {
    ...
    private func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            photosStackView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: horizontalPadding),
            photosStackView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -horizontalPadding),
